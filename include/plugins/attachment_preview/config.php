...
class AttachmentPreviewPluginConfig extends PluginConfig {
    ...
    function getOptions() {
        ...
        return array(
            ...
            'attach-image'         => new BooleanField(array(
                'label'   => $__('Inline image files as <img>s'),
                'default' => TRUE
                    )
            ),
            'attach-text'          => new BooleanField(array(
                'label'   => $__('Inline textfiles (txt,csv) as <pre>'),
                'default' => TRUE
                    )
            ),
            'attach-html'          => new BooleanField(array(
